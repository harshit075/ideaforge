    ...
    <div className="w-full space-y-8 animate-fadeIn">
      ...
      <div className="space-y-4">
        <div className="inline-flex items-center gap-2 bg-orange-100 border border-orange-200 text-[#E05315] text-xs font-bold px-3.5 py-1.5 rounded-full">
          ...
          <span>Bhasha Protocol · One Meaning, Every Language</span>
        </div>
        ...
        <p className="text-base text-[#57534E] max-w-3xl leading-relaxed">
          Traditional translation loses critical dates, names, and prerequisites during handoffs (e.g. 4 PM becomes 4 AM). Bhasha extracts an intermediate <strong>Meaning Packet</strong> with locked facts, guaranteeing Rahul, Kenji, and Alex receive culturally natural instructions from the exact same source of truth.
        </p>
      </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-3 bg-[#FAF8F3] rounded-2xl border border-[#EAE2D5] space-y-1.5 text-xs">
                      <div className="flex items-center justify-between">
                        ...
                        <strong className="text-[#1C1917] font-mono">{card.locked_summary.owner} 🔒</strong>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-[#78716C]">Deadline:</span>
                        <strong className="text-[#E05315] font-mono">{card.locked_summary.deadline} 🔒</strong>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-[#78716C]">Condition:</span>
                        <span className="text-[11px] font-medium text-[#1C1917] text-right truncate max-w-[140px]">
                          {card.locked_summary.condition} 🔒
                        </span>
                      </div>
                    </div>
                  </div>
